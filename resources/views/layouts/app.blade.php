...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KZ42N969"
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModal" aria-hidden="true">
            ...
            <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">اضافه للدليل </h1>
                            ...
                            <div class="col-md-12">
                                ...
                                <form method="post" action="/add-directory" class="needs-validation" novalidate>
                                            ...
                                            <div class="form-group col-sm-6 mb-3">
                                                ...
                                                <select required name="category_id" id="category_id" class="form-control">
                                                    ...
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}"  @if(!empty($category_id)) {{ ($category->id == $category_id) ? 'selected' : '' }}@endif>
                                                            {{ $category->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div id="saveActions" class="form-group my-3">
                                        ...
                                        <div class="btn-group  mb-0 d-flex justify-content-between align-items-center" role="group"  >
